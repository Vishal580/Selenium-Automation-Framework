package com.vishal.projects.crm.testcases;

import com.vishal.annotations.FrameworkAnnotation;
import com.vishal.common.BaseTest;
import com.vishal.dataprovider.DataProviderManager;
import com.vishal.enums.AuthorType;
import com.vishal.enums.CategoryType;

import static com.vishal.keywords.WebUI.*;

import com.vishal.projects.crm.pages.Clients.ClientPageCRM;
import com.vishal.projects.crm.pages.Dashboard.DashboardPageCRM;
import com.vishal.projects.crm.pages.SignIn.SignInPageCRM;
...
public class ClientTest extends BaseTest {
    ...
    @FrameworkAnnotation(author = {AuthorType.Vishal, AuthorType.AnVo}, category = {CategoryType.REGRESSION})
